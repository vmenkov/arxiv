...
<p>The list was generated by applying the user profile to the 
<%= main.days>0? "articles from the last " + main.days + " days" :
    "entire article archive" %>. The list contains <%=main.entries.size() %> articles; the top <%= Math.min(main.entries.size(), main.maxRows) %> are shown below.
</p>
