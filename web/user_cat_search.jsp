...
<meta name="Description" content="Results of a search of recent documents in the user's categories of interest against the local copy of the arxiv.org database" />
...
<div id="upper_frame">
	...
	Search is based on your categories of interest
<!--
...
<%   } else {      %>
		...
		<p>This list shows some of the most recent articles in your categories of interest. To change the list of categories, <a href="personal/editUserFormSelf.jsp">modify your profile</a>
