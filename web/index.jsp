...
<p class="researcher">The list was 
...
<%= (main.days>0)? "articles from the last " + main.days + " days" :
    "entire article archive (all times)" %></p>
<p class="researcher">Merge=<%=main.teamDraft%></p>
<% } 
} %>
...
<% if (main.runByResearcher()) { %>
<p class="researcher"><small>(<%= main.actor.dayMsg()%>)</small></p>
