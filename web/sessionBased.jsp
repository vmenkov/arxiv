...
onclick="javascript:window.opener.location.href='<%=main.getParticipationUrl()%>';">sign-up</a> to preserve your suggestions and gain additional options! (Or <a name="register" title="Sign up with My.ArXiv!"
