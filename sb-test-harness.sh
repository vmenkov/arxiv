...
set cp="$lib/axs.jar:$lib/colt.jar:$lib/commons-fileupload-1.2.1.jar:$lib/commons-io-1.4.jar:$lib/lucene-core-3.3.0.jar:$lib/mysql-connector-java-3.1.12-bin.jar:$lib/nutch-0.7.jar"
...
if ("$1" == "") then
    echo 'Usage: sb-test-harness.sh input-file-name'
    exit
endif

/usr/bin/time java $opt -DsbMergeWithBaseline=false \
-DsbMethod=$sbMethod \
edu.rutgers.axs.sb.SBRGeneratorCmdLine $1 
