    ...
    public int doStartTag() throws JspException {
	    ...
	    out.println("<hr><div align=right>" +
			(user==null? "Not logged in" : 
			 ...
			 "</em> (<a href=\""+cp+"/personal/index.jsp\">My account</a>) (<a href=\""+cp+"/logout.jsp\">Log out</a>)"
) +
			"</div>");
	    out.println("<hr><div align=center>Rutgers University <a href=\""+cp+"\">My.arXiv</a>. Application ver. "+Version.version+"</div>");
        } catch (Exception ex) {
