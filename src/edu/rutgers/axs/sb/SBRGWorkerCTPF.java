...
class CTPFFit extends Object {
	...
	//        Logging.info("CTPFFit: size of internalID_to_aID: " + internalID_to_aID.size());
        Logging.info("CTPFFit: size of aID_to_internalID: " + aID_to_internalID.size());
	String msg = (gapCnt==0)? " all AID values have been loaded" :
	    "" + gapCnt + " AID values are missing!";
	Logging.info("CTPFFit: for 0<=internalID<" + num_docs +", " +msg);
    }
...
public class SBRGWorkerCTPF extends  SBRGWorker  {
    ...
    /** Extra parameters */
    double temperature = Double.POSITIVE_INFINITY, D=0;
 ...
 */
	...
	s += "; x_shape_prior="+ x_shape_prior +", x_rate_prior=" + x_rate_prior +", factor=" + factor + ". D=" + D+", T=" + temperature;
