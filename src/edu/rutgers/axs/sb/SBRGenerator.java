...
public class SBRGenerator {
    ...
    */
	...
	SUBJECTS,
	/** Not an actual method. This param value is used on session
	    initialization to randomly choose one of the "real"
	    methods. After that, the sbMethod parameter in the SBR
	    generator is set to that real method. 	    */
	RANDOM,
        /** Collaborative topic Poisson factorization (Gopalan, Charlin, Blei, 2014). This was never put into production. */
        CTPF; 
    };
